                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: 120,
                        child: Text(
                          '$currency ${widget.transitionModel.totalAmount!.toDouble() + widget.transitionModel.discountAmount!.toDouble() - widget.transitionModel.vat!.toDouble()}',
                          maxLines: 2,
                          style: kTextStyle.copyWith(
                              color: kTitleColor, fontWeight: FontWeight.bold),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        width: 120,
                        child: Text(
                          '$currency ${(widget.transitionModel.paidamountamount! - widget.transitionModel.totalAmount!) < 0 ? 0 : (widget.transitionModel.paidamountamount! - widget.transitionModel.totalAmount!).toStringAsFixed(2)}',
                          maxLines: 2,
                          style: kTextStyle.copyWith(
                              color: kTitleColor, fontWeight: FontWeight.bold),
                          textAlign: TextAlign.end,
